...
public final class Variables {
	...
	public static final double 	MINIMUM_HEIGHT = -1000;
	public static final double 	MAXIMUM_HEIGHT = 3000;
	...
	public static final double	MAXIMUM_START_HEIGHT = 20 * 100; // exclusive
	public static final double	MINIMUM_FLAG_HEIGHT = 0; // inclusive
	public static final double	MAXIMUM_FLAG_HEIGHT = 20 * 100; // exclusive
